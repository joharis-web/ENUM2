        ...
        <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
            <div
                ...
                <nav :class="{'block': open, 'hidden': !open}"
                    ...
                    <x-admin-nav-link :href="route('admin.pesanan.index')" :active="request()->routeIs('admin.pesanan.index')">
                        {{ __('Pesanan') }}
                    </x-admin-nav-link>

                    <x-admin-nav-link :href="route('admin.pembayaran.index')" :active="request()->routeIs('admin.pembayaran.index')">
                        {{ __('Transaksi') }}
                    </x-admin-nav-link>
